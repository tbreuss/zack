    ...
    [
        ...
        'routes' => [
            ...
            [
                'name' => 'Find pet by ID.',
                'method' => 'GET',
                'path' => '/api/petstore3/pet/10',
                'body' => ''
            ],
            [
                'name' => 'Updates a pet in the store with form data.',
                'method' => 'POST',
                'path' => '/api/petstore3/pet/10?name=doggie&status=available',
                'body' => ''
            ],
            [
                'name' => 'Deletes a pet.',
            ...
            [
                ...
                'method' => 'POST',
                'path' => '/api/petstore3/pet/10/uploadImage?additionalMetadata=string',
    ...
    [
        ...
        'routes' => [
            ...
            [
                ...
                'method' => 'GET',
                'path' => '/api/petstore3/store/order/10',
                'body' => null
            ],
            [
    ...
    [
        ...
        'routes' => [
            ...
            [
                ...
                'method' => 'GET',
                'path' => '/api/petstore3/user/login?username=doggie&password=available',
                'body' => null
            ],
            [
            ...
            [
                ...
                'method' => 'GET',
                'path' => '/api/petstore3/user/10',
                'body' => null
            ],
            [
                'name' => "Updated user.",
                'method' => "PUT",
                "path" => "/api/petstore3/user/theUser",
